...
# Boy Event
RIGHT_DOWN, LEFT_DOWN, RIGHT_UP, LEFT_UP, SLEEP_TIMER, RUN, WALK = range(7)
...
key_event_table = {
    ...
    (SDL_KEYDOWN, SDLK_LSHIFT): RUN,
    (SDL_KEYDOWN, SDLK_RSHIFT): RUN,
    (SDL_KEYUP, SDLK_LSHIFT): WALK,
    (SDL_KEYUP, SDLK_RSHIFT): WALK
}
...
class DashState:
    ...
    def do(boy):
        ...
        if boy.timer == 0 and boy.velocity < 0:
            boy.add_event(WALK)
        elif boy.timer == 0 and boy.velocity > 0:
            boy.add_event(WALK)
